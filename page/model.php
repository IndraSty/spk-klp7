...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($update) {
		$sql = "UPDATE model SET kd_kriteria='$_POST[kd_kriteria]', bobot='$_POST[bobot]' WHERE kd_model='$_GET[key]'";
	} else {
		$sql = "INSERT INTO model VALUES (NULL, '$_POST[kd_kriteria]', '$_POST[bobot]')";
		$validasi = true;
	}
	    ...
	    <div class="panel panel-info">
	        ...
	        <div class="panel-body">
	            <table class="table table-condensed">
	                ...
	                <tbody>
	                    <?php $no = 1; ?>
	                    <?php if ($query = $connection->query("SELECT b.nama AS nama_kriteria, a.bobot, a.kd_model FROM model a JOIN kriteria b ON a.kd_kriteria=b.kd_kriteria")): ?>
